...
import AddDatePickerEventModal from "./DatePickerEventModal.tsx";
...
const MyCalendar = () => {
  ...
  const onAddEvent = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    const data: IEventInfo = {
      ...eventFormData,
      _id: generateId(),
      start: (currentEvent as Event)?.start,
      end: (currentEvent as Event)?.end,
    };
  ...
  const onAddEventFromDatePicker = (e: React.MouseEvent<HTMLButtonElement>) => {
    e.preventDefault();
    ...
    const data: IEventInfo = {
      ...
      end: datePickerEventFormData.allDay ? addHours(datePickerEventFormData.start, 12) : setMinToZero(datePickerEventFormData.end),
    };
    const newEvents = [...events, data];
    setEvents(newEvents);
    setDatePickerEventFormData(initialDatePickerEventFormData);
  ...
  return (
    ...
    >
      <Container maxWidth={false}>
        <Card>
          <CardHeader  subheader="Calendrier Scolaire" />
          <Divider />
          <CardContent>
