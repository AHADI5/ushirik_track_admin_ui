...
export default function AppHeader (topBarInfo) {
  return (
    <div className="nav-menu sticky top-0 inset-x-0 flex  sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py- sm:py-4 lg:ps-64 ">
      <div
